...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Acme&family=Irish+Grover&family=Josefin+Sans:ital,wght@0,100..700;1,100..700&family=Sawarabi+Gothic&family=Slackey&display=swap" rel="stylesheet">
...
<header id="pet_header">
        <div class="pet_header">
        <p><?=h($row['title'])?></p>
        </div>
    </header>

   <div class="petimg_wrap">
  ...
  <img class="modal-content" id="modal-img">
    ...
    <div class="tobtn"><a href="select.php" class="pet_btn">Back to List</a></div>
